(function () {
  ...
  const COPY = {
    ko: {
      ...
      nickHistory: '닉네임 변경 이력', nickHistoryEmpty: '변경 이력이 없습니다.',
      nickUsed: '{used} / {limit}회 사용', nickReset: '변경 횟수 초기화',
      nickKindAuto: '자동 부여', nickKindUser: '본인 변경', nickKindAdmin: '관리자 변경',
      nickResetConfirm: '{name} 님의 닉네임 변경 횟수를 초기화할까요? 이력은 지우지 않고 기준만 옮깁니다.',
      nickResetFailed: '변경 횟수를 초기화하지 못했습니다.',
      nickSet: '닉네임 변경', nickBlankAuto: '비우면 자동 생성',
      nickSetHint: '관리자 변경은 회원의 2회 제한을 쓰지 않습니다. 이력에는 남습니다.',
      nickSetFailed: '닉네임을 바꾸지 못했습니다.',
      copyId: '회원 ID 복사', copied: '복사했습니다',
    ...
    en: {
      ...
      nickHistory: 'Nickname history', nickHistoryEmpty: 'No changes yet.',
      nickUsed: '{used} of {limit} used', nickReset: 'Reset change count',
      nickKindAuto: 'Assigned', nickKindUser: 'By member', nickKindAdmin: 'By admin',
      nickResetConfirm: 'Reset the nickname change count for {name}? The history is kept; only the counting point moves.',
      nickResetFailed: 'Could not reset the change count.',
      nickSet: 'Set nickname', nickBlankAuto: 'Blank assigns a new one',
      nickSetHint: 'An admin change does not consume the two changes a member gets. It is still recorded in the history.',
      nickSetFailed: 'Could not change the nickname.',
      copyId: 'Copy member ID', copied: 'Copied',
    ...
    zh: {
      ...
      nickHistory: '昵称修改记录', nickHistoryEmpty: '暂无修改记录。',
      nickUsed: '已用 {used}/{limit} 次', nickReset: '重置修改次数',
      nickKindAuto: '自动分配', nickKindUser: '本人修改', nickKindAdmin: '管理员修改',
      nickResetConfirm: '要重置 {name} 的昵称修改次数吗？记录会保留，仅移动计数起点。',
      nickResetFailed: '未能重置修改次数。',
      nickSet: '修改昵称', nickBlankAuto: '留空则自动生成',
      nickSetHint: '管理员修改不占用会员的 2 次额度，但仍会记录在案。',
      nickSetFailed: '未能修改昵称。',
      copyId: '复制会员 ID', copied: '已复制',
    ...
    ja: {
      ...
      nickHistory: 'ニックネーム変更履歴', nickHistoryEmpty: '変更履歴はありません。',
      nickUsed: '{used}/{limit}回 使用', nickReset: '変更回数をリセット',
      nickKindAuto: '自動付与', nickKindUser: '本人による変更', nickKindAdmin: '管理者による変更',
      nickResetConfirm: '{name} さんのニックネーム変更回数をリセットしますか？履歴は消さず、起点だけを移します。',
      nickResetFailed: '変更回数をリセットできませんでした。',
      nickSet: 'ニックネーム変更', nickBlankAuto: '空欄なら自動生成',
      nickSetHint: '管理者による変更は会員の2回の上限を消費しません。履歴には残ります。',
      nickSetFailed: 'ニックネームを変更できませんでした。',
      copyId: '会員IDをコピー', copied: 'コピーしました',
