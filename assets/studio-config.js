...
/* 양도·양수.
   ...
   2026-08-10 받는 화면까지 붙었지만 다시 내려 둡니다. 양쪽을 실제로
   주고받아 보기 전에는 내보내지 않습니다 — 개체가 남의 계정으로
   넘어가는 일이라, 한 번 잘못되면 되돌릴 방법이 없습니다.

   끄면 새 링크를 만들 수 없습니다. 이미 만들어진 링크는 서버가 그대로
   처리하므로, 받는 화면(/care/transfer.html)은 계속 동작합니다 — 켜 둔
   동안 나간 링크가 갑자기 죽으면 그게 더 나쁩니다. */
