...
(function (w) {
  ...
  L.ja = {
    ...
    metaDesc: 'クリーチャーケアログの無料範囲とプレミアム機能を比較してご案内します。個体登録数、ブリーディング管理、公開プロフィールなどの違いをご確認ください。',
    ogDesc: '無料でどこまで使えて、プレミアムで何が開くのかをまとめました。',
    back: '← スタジオ', h1: '料金案内',
    sub: 'クリーチャーケアログを無料でどこまで使えるか、<br>プレミアムで何が開くのかをまとめました。',
    language: '言語',
  ...
  L.zh = {
    ...
    metaDesc: '对比生物护理日志的免费范围与高级功能，包括个体登记数量、繁育管理、公开繁育者主页等差异。',
    ogDesc: '免费能用到哪里，高级版又能开启什么。',
    back: '← 工作室', h1: '价格说明',
    sub: '生物护理日志免费能用到哪里，<br>以及高级版会开启什么。',
    language: '语言',
