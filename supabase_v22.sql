/* =============================================================================
   ...
   **확률에 직접 영향을 줍니다.**
   ...
   레드데빌은 벨 알비노를 깔고 가는 라인입니다. 이 연결이 없으면
   레드데빌끼리 붙였을 때 새끼가 100% 벨 알비노인데 화면에는 0% 로 나오고,
   노멀과 붙이면 100% het 벨인데 그것도 안 나옵니다. 틀린 확률이 오류 없이
   조용히 나오는 쪽이라 더 위험합니다.
   ...
   계산기에서 레드데빌 칩을 켜면 벨 알비노도 같이 켜지고, 왜 켜졌는지
   칩 아래에 적힙니다. 사용자의 레드데빌이 벨을 안 물고 있으면 벨 알비노
   칩을 직접 끄면 됩니다 — 그때는 확률이 어긋났다는 경고가 뜹니다.
   ...
   ---------------------------------------------------------------------------
     ...
     레드데빌  붉은 발색 라인 — 단, 벨 알비노를 깔고 갑니다(위 참고).
